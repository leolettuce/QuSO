...
def extract_runtime_circuit(m=1):
    epsilon=0.1
    kappa = 1
    ...
    print(f"m={m} done! ({synthesis_time+simulation_time} seconds)")

    return synthesis_time, simulation_time
...
def main():
    ...
    runtime = extract_runtime_circuit(args.m)

    script_dir = os.path.dirname(os.path.abspath(__file__))
    outpath = os.path.join(script_dir, 'data', f"runtime_cq.pkl")
